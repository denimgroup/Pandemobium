    ...
    <div id="container">
        <ul>
            <a href="trade://buy?symbol=GOOG&shares=10"><li class="clearfix">
                <h2>Buy Stock</h2>
                <p class="desc">
                    Purchase stock through use of schema exploit
                </p>
            </li></a>
            <a href="trade://sell?symbol=GOOG&shares=10"><li class="clearfix">
                <h2>Sell Stock</h2>
                <p class="desc">
                    Sell stock through use of schema exploit
                </p>
            </li></a>
            ...
            <a href="../web/tips.jsp?query=insert%20into%20version%28log%29%20values%28%27l337%20h4x0R%27%29"><li class="clearfix">
                <h2>Update App</h2>
                <p class="desc">Update to malicious version of Pandemobium </p>
            </li></a>
            <a href="about.jsp#sqlinjection"><li class="clearfix">
                <h2>SQL Injection</h2>
                <p class="desc">Inject Malicious SQL Query</p>
            </li></a>
            <a href="about.jsp#xss"><li class="clearfix">
                <h2>XSS</h2>
                <p class="desc">XSS-Cross Site Scripting</p>
            </li></a>

            <a href="about.jsp#locationservice"><li class="clearfix">
                <h2>Location Service Exploit</h2>
                <p class="desc">Use GPS coordinates</p>
            </li></a>
            <a href="about.jsp#sslcertificate"><li class="clearfix">
