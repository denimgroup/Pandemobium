...
@interface BuyViewController : UIViewController <UITextFieldDelegate, YFStockDetailsLoaderDelegate> {
 
    IBOutlet UITextField * symbolField;
    IBOutlet UITextField * sharesField;
    IBOutlet UILabel * stockResults;
    IBOutlet UILabel * buyStatus;
